...
URL: https://leetcode.com/problems/daily-temperatures/?envType=study-plan-v2&envId=leetcode-75
...
class Solution:
    def dailyTemperatures(self):  # TODO: adjust parameters
        """
...
# Example:
# s = Solution()
# print(s.dailyTemperatures(/* args */))
